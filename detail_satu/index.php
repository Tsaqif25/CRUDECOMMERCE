<?php
$project = mysqli_query($koneksi, "SELECT * FROM produk JOIN kategori ON produk.id_kategori=kategori.id_kategori where id_produk='$_GET[id_produk]'");
...
<!--================Single Product Area =================-->
<form action="keranjang/uptocart.php" method="post" enctype="multipart/form-data">
	<input type="hidden" name="id_user" id="" value="<?= $iduser['id_user'] ?>">
	<input type="hidden" name="produk" id="" value="<?= $data['id_produk'] ?>">
			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					...
					<div class="s_product_text">
						...
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : <?= $data['nama_kategori'] ?></a></li>
						...
						<div class="product_count">
							...
							<input type="text" name="kuantitas" id="sst" size="2" maxlength="12" value="1" title="Quantity:" class="input-text qty">
							...
							<br><br>
							<button class="btn btn-primary" style="background-color: blue;" type="submit">Add to Cart</button>
						</div>
